...
ADTOffroadCar::ADTOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDTOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDTOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDTOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDTOffroadWheelRear::StaticClass();
