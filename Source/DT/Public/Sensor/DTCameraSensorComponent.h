...
#include "DTSensorTypes.h"
#include "Components/SceneComponent.h"
#include "DTCameraSensorComponent.generated.h"
...
class DT_API UDTCameraSensorComponent : public USceneComponent
{
	GENERATED_BODY()

public:
	UDTCameraSensorComponent();
