...
ADTSportsCar::ADTSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDTSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDTSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDTSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDTSportsWheelRear::StaticClass();
